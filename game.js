...
$(document).ready(function(){
  ...
  alert("Bem vindo ao Jogo da Memoria - Joker vs1.0 - Única instrução para usar o jogo: Escreva seu nome no campo 'Usuário' depois clique em 'Start/Reset'. Bom jogo!");
  var carta_virada = 0;
  var aux = null;
  var hit = 0;
